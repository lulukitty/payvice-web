...
<div class="p-20" id="page-content-wrapper">
	...
	<div class="row no-margin d-flex justify-content-center align-content-center">
<div class="col-lg-8 col-lg-offset-2 col-md-offset-1 col-sm-offset-2 col-md-9 col-sm-12 col-xs-12 padded-area">
	...
	<div id="dashboard">
		...
		<div class="col-md-12 col-sm-12 payProcess"></div>
					<div class="d-flex justify-content-center align-content-center">
						<div class = "col-lg-15" style="padding-bottom:20px;">
							<h4 class="text-center bold">Commision Balance:</h4>
							<h4 class="text-center bold">&#8358;{{ $commissionBalance }}</h4>
						</div>
						<div class = "col-lg-12">
