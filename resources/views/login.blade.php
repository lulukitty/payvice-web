				...
				<div class="col-lg-4 col-md-6 col-sm-8 col-xs-12 ">
					...
					<div class="mb30"><a href="/"><img class="logo-light" src="{{ URL::asset('assets/img/logo_payvice.png') }}" alt=""></a></div>
						<div class="panel-body paddfformsmall">
							<form action="#" method="post" id="payviceUserLogin" data-parsley-validate>
								<div class=" form-group">
								<i class="ion-android-person fstylec"></i>
									<input class="form-control" type="text" id="newsletter-email" name="email" placeholder="Your Email/Phone Number" required>
								</div>
								<div class=" form-group">
