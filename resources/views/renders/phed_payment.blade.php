...
<div class="mainForm">
    <form accept-charset="utf-8" data-parsley-validate>
        <div class="form-group">
            <div class="input-group">
                ...
                <input type="hidden" name="meter" value="{{$account}}" />
        ...
        <div>
            <table class="table table-bordered" style="text-align: left; font-size: 11px; width: 80%;">
                <div class="form-group">
                    <tr>
                        <td align="center"><b>Address</b></td><td>{{ !empty($address) ? $address : ' -- -- --' }}</td>
                    </tr>
                    <tr>
                        <td align="center"><b>Account Type</b></td><td>{{$type}}</td>
                    </tr>
                    <tr>
                        <td align="center"><b>Tariff</b></td><td>{{$tariff}}</td>
                    </tr>
                    <tr>
                        <td align="center"><b>Meter Number</b></td><td>{{$meterNumber}}</td>
                    </tr>
                    <tr>
                        <td align="center"><b>Total Bill</b></td><td>&#8358; {{ number_format($totalBill) }}</td>
                    </tr>
        ...
        <div>
            <table class="table" style="text-align: right; width: 60%;">
                <tr>
                    <td>Enter Phone Number: </td> <td><input type="number" name="phone" required placeholder=" 080XXXXXXXXX "/></td>
                </tr>
                <tr>
    ...
    <input type="hidden" name="view" value="{{ rand() }}" />
                <div class="form-group">
                <button type="submit" class="vendButton btn-customb btn-block arrow-btn waves-effect waves-classic">
...
<script>
    ...
    $('form').submit(function(e){
      ...
      formDatas.append('service', "phedc");
      ...
      if (request.readyState === 4) {
        if (request.status === 200) {
          ...
          $('div#alert').text(response.data.message);
              ...
              $(".paymentDetails").html(
                `<div class='bg-info mb-4' style="padding: 10px"><strong>Payvice Web PHEDC Transaction Details</strong></div>
                <table class="table">
                <tr class="text-left">
                <td>Status:</td>
            ...
            <div id="clearIbedcPurchase" class="btn btn-info">Refresh</div>
                `
            );
            $(document).on('click', '#clearIbedcPurchase', function(event) {
