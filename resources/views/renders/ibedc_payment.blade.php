    ...
    <form accept-charset="utf-8" data-parsley-validate>
        ...
        <center>
            <table class="table table-bordered" style="text-align: left; font-size: 11px; width: 80%;">
                <div class="form-group">
                        <tr>
                            <td align="center"><b>Address</b></td><td>{{$address}}</td>
                        </tr>
                    <tr>
...
$(document).ready(function(){
    $('form').submit(function(e){
      ...
      formDatas.append('service', "ibedc");
      ...
      if (request.readyState === 4) {
        if (request.status === 200) {
          ...
          $('div#alert').text(response.data.message);
              ...
              $(".paymentDetails").html(
                `<div class='bg-info mb-4' style="padding: 10px"><strong>Payvice Web IBEDC Transaction Details</strong></div>
                <table class="table">
                <tr class="text-left">
                <td>Status:</td>
                ...
                <tr class="text-left">
                <td>Units:</td>
                <td>${data.tokenDetailsKWH || data.units || ""} </td>
                </tr>
                <tr class="text-left">
                <td>Meter Number:</td>
                ...
                <tr class="text-left">
                <td>Account Type:</td>
                <td>${ data.tokenDetailsDescription || data.account_type || "" }</td>
                </tr>
                <tr class="text-left">
