					...
					<div class="panel with-nav-tabs no-border panel-default">					
						<div class="panel-body paddfform">
							<div class=" form-group text-center">
								<h4 class="ft-w-b">Enter Your Password</h4>
								<p class="ft-w-l medium">Choose a strong password. An ideal password should contain uppercase characters, symbols and numbers</p>
							</div>
							...
							<form action="#" method="post" id="viceCreateStepTwo" data-parsley-validate>
								
								<div class=" form-group">

									<input class="form-control" type="password" id="userPassword" name="password" placeholder="Enter your Password" data-parsley-minlength="8" required>
								</div>

								<div class=" form-group">

									<input class="form-control" type="password" id="newsletter-email" name="repeatPass" placeholder="Confirm your Password" data-parsley-minlength="8" data-parsley-equalto="#userPassword" required>
								...
								<div class="form-group">
									...
									<button type="submit" class="btn-customb btn-block arrow-btn waves-effect waves-classic">
										<span class="loginBtn">CHOOSE TRANSACTION PIN</span>
