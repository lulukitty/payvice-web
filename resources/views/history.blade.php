          ...
          <div class = "col-md-12">
            ...
            <table class="table r-font re-tbl-bordered table-striped table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td >Amount: </td>
                  <td class = "transactionview-nairaAmount"></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td >Beneficiary: </td>
                  <td class = "transactionview-VasCustomerAccount"></td>
                </tr>
                <tr>
                  <td>Address: </td>
                  <td class = "transactionview-VasCustomerAddress"></td>
                </tr>
                <tr>
                  <td>IP Address: </td>
                  <td class = "transactionview-location"></td>
                </tr>
              </tbody>
            </table>
          </div>
                          ...
                          <div class="panel-body" id="dashboard">
														<div id ="transactionHistory">
																<div class="row">
																	<div class="col-lg-12 hidden text-center col-md-12 col-sm-12 col-xs-12">
																		...
																		<h1 class="bold big-font no-margin fg-green">&#8358;{{ number_format(floatval($balance), 2) }}</h1>
                                      ...
                                      <div class="form-group">
                                        <select class="form-control-alt" name = "product">
                                          ...
                                          @foreach ($products as $item)
                                            <option @if ($currentProduct == $item->value) selected @endif value = "{{$item->value}}">{{$item->label}}</option>
                                          @endforeach
                                        </select>
                                      </div></div>
                                ...
                                <div class="col-md-4">
                                    <div class="well well-sm">
                                      <p class="mb-20">Total Transactions <span class="badge right">{{$transactionSummary->transactionCount}}</span> </p>
                                      <h4>&#8358; {{ number_format($transactionSummary->totalAmount/100, 2) }}</h4>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="well well-sm">
                                      <p class="mb-20">Successful <span class="badge right">{{$transactionSummary->successfulCount}}</span> </p>
                                      <h4>&#8358; {{ number_format($transactionSummary->successfulAmount/100, 2) }} </h4>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="well well-sm">
                                      <p class="mb-20">Failed <span class="badge right">{{$transactionSummary->failedCount}}</span></p>
                                      <h4>&#8358; {{ number_format($transactionSummary->failedAmount/100, 2)}} </h4>
                                    </div>
                                </div>
                                <div class="col-md-12 text-right">
                                    {{-- <button type="button" class="btn btn-sm btn-default" data-toggle="modal" data-target="#productSummarryModal"><i class="fa mr-5 fa-eye"></i>View Detailed Product Summarry</button> --}}
                                      <a href="{{url('/dashboard/account-history')}}" target="_blank" class="btn btn-sm btn-default" data-toggle="modal"><i class="fa mr-5 fa-eye"></i>View Wallet Account History</a>
                            ...
                            <div class="col-lg-12">
                              <div class="row">
                               <div class = "col-lg-12">
                                ...
                                <div class = "table-responsive">
                                  <table id="transactions" class="table r-font re-tbl-bordered table-striped table-hover">
                                    <thead>
                                      <tr>
                                        <th> # </th>
                                        <th> Trans Seq. </th>
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td>&#8358; {{ number_format($transaction->nairaAmount, 2) }}</td>
                                        <td>{{$transaction->VASCustomerAccount}}</td>
