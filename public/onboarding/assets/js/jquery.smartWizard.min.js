! function(t, s, e, n) {
    ...
    t.extend(i.prototype, {
        ...
        _setToolbar: function() {
            ...
            var s, e, n = !1 !== this.options.toolbarSettings.showNextButton ? t("<button></button>").text(this.options.lang.next).addClass("btn btn-secondary sw-btn-next").attr("type", "button") : null,
                ...
                a = null;
            switch (this.options.toolbarSettings.toolbarExtraButtons && this.options.toolbarSettings.toolbarExtraButtons.length > 0 && (a = t("<div></div>").addClass("btn-group mr-2 sw-btn-group-extra").attr("role", "group"), t.each(this.options.toolbarSettings.toolbarExtraButtons, function(t, s) {
                a.append(s.clone(!0))
            })), this.options.toolbarSettings.toolbarPosition) {
                case "top":
                    (s = t("<div></div>").addClass("btn-toolbar sw-toolbar sw-toolbar-top justify-content-" + this.options.toolbarSettings.toolbarButtonPosition)).append(o), "start" === this.options.toolbarSettings.toolbarButtonPosition ? s.prepend(a) : s.append(a), this.container.before(s);
                    break;
                case "bottom":
                    (e = t("<div></div>").addClass("btn-toolbar sw-toolbar sw-toolbar-bottom justify-content-" + this.options.toolbarSettings.toolbarButtonPosition)).append(o), "start" === this.options.toolbarSettings.toolbarButtonPosition ? e.prepend(a) : e.append(a), this.container.after(e);
                    break;
                case "both":
                    (s = t("<div></div>").addClass("btn-toolbar sw-toolbar sw-toolbar-top justify-content-" + this.options.toolbarSettings.toolbarButtonPosition)).append(o), "start" === this.options.toolbarSettings.toolbarButtonPosition ? s.prepend(a) : s.append(a), this.container.before(s), (e = t("<div></div>").addClass("btn-toolbar sw-toolbar sw-toolbar-bottom justify-content-" + this.options.toolbarSettings.toolbarButtonPosition)).append(o.clone(!0)), null !== a && ("start" === this.options.toolbarSettings.toolbarButtonPosition ? e.prepend(a.clone(!0)) : e.append(a.clone(!0))), this.container.after(e);
                    break;
                default:
                    (e = t("<div></div>").addClass("btn-toolbar sw-toolbar sw-toolbar-bottom justify-content-" + this.options.toolbarSettings.toolbarButtonPosition)).append(o), this.options.toolbarSettings.toolbarButtonPosition, e.append(a), this.container.after(e)
            }
            return !0
        },
        _setEvents: function() {
            ...
            return t(this.steps).on("click", function(t) {
                ...
                if (!1 === n.options.anchorSettings.enableAnchorOnDoneStep && n.steps.eq(s).parent("li").hasClass("done")) return !0;
                s !== n.current_index && (!1 !== n.options.anchorSettings.enableAllAnchors && !1 !== n.options.anchorSettings.anchorClickable ? n._showStep(s) : n.steps.eq(s).parent("li").hasClass("done") && n._showStep(s))
        ...
        _loadStepContent: function(s) {
            ...
            if (null !== this.current_index && this.current_index !== s && (i = this.current_index < s ? "forward" : "backward"), null !== this.current_index && !1 === this._triggerEvent("leaveStep", [n, this.current_index, i])) return !1;
