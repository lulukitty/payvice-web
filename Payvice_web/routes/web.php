...
Route::get('/vice/privacy-policy', function () {
	return view('privacy');
});
...
Route::get('/vice/block_wallet', function(){
	return view('block_wallet');
});
...
Route::group(['prefix' => 'tran', 'middleware' => 'payvice'], function(){
	...
	Route::get('/block_wallet', 'AccessController@blockWallet');
	//Route::post('/block_wallet', 'AccessController@newBlockAgentWallet');
