...
<div class="mainForm">
    <form id="ikedc" accept-charset="utf-8" data-parsley-validate>
        <div class="form-group">
            <div class="input-group">
                ...
                <input type="hidden" name="meter" value="{{$customerMeterNo}}" />
      ...
      if (request.readyState === 4) {
        if (request.status === 200) {
          ...
          $('div#alert').text(response.data.message);
              ...
              $(".paymentDetails").html(
                `<div class='bg-info mb-4' style="padding: 10px"><strong>Payvice Web AEDC Transaction Details</strong></div>
                <table class="table">
                <tr class="text-left">
                <td>Status:</td>
