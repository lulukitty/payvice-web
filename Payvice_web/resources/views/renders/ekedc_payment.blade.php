...
<div class="mainForm">
    <form accept-charset="utf-8" data-parsley-validate>
        <div class="form-group">
            ...
            <input class="form-control" type="text" value="{{$name}} - ( {{$accountNumber}} )" readonly name="">
    ...
    <table class="table table-bordered" style="text-align: left; font-size: 11px; width: 80%;">
        <div class="form-group">
            <tr>
                <td align="center"><b>Account Type</b></td><td>{{$account_type}}</td>
            </tr>
            <tr>
                <td align="center"><b>Address</b></td><td>{{is_array($address) ? "" : $address}}, DISTRICT: {{$businessDistrict}}</td>
            </tr>
        </div>
    </table>
    </center>
...
<script>
    ...
    $('form').submit(function(e){
      ...
      formDatas.append('service', "ekedc");
      ...
      if (request.readyState === 4) {
        if (request.status === 200) {
          ...
          $('div#alert').text(response.data.message);
              ...
              $(".paymentDetails").html(
                `<div class='bg-info mb-4' style="padding: 10px"><strong>Payvice Web EKEDC Transaction Details</strong></div>
                <table class="table">
                <tr class="text-left">
                <td>Status:</td>
