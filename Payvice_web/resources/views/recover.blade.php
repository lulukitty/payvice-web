				...
				<div class="col-lg-4 col-md-6 col-sm-8 col-xs-12 ">
					...
					<div class="mb30"><a href="/"><img class="logo-light" src="../assets/img/logo_payvice.png" alt=""></a></div>
						<div class="panel-body paddfformsmall">
							...
							<form action="#" method="post" id="payviceRecoverPassword" data-parsley-validate>
								<div class=" form-group">

									<input class="form-control" type="email" id="newsletter-email" name="email" placeholder="Enter Your Email" required>
								</div>
								<div class="form-group">
									...
									<button type="submit" class="btn-customb btn-block arrow-btn waves-effect waves-classic">
										<span class="loginBtn">RECOVER PASSWORD</span>
