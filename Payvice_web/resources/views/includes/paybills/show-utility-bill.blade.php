<div class="row">
        ...
        <div id="billstepone_utility" class="panel mt-30 bordered panel-default showdisappear">
            <div class="panel-body p-30">
              <form action="#" accept-charset="utf-8" id="utilOption" data-parsley-validate>
                    ...
                    <div class="form-group-b">
                      ...
                      <input type="number" name="amount" class="form-control" required placeholder=" Amount (N) "/><br>
                </div>
                    <div class="form-group-b">
  ...
  <div class="row">
    ...
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
      <div id="billsteptwo_utility" class="panel panel-default  no-bd shadow">
